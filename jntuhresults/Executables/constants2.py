...
# arr21=[1391,1425,1449,1496,1560,1610]
...
def exam_codes(code,htno):
    s_year=int("20"+htno[:2])
    c_year=int(datetime.date.today().year)
    print(s_year,c_year)
    if (code =="1-1"):
        lis=[]
        for i in range(s_year,c_year+1):
            lis.append(examcodes_dic["11"].get(str(i)))
        return lis
    elif(code =="1-2"):
        lis=[]
        for i in range(s_year,c_year+1):
            lis.append(examcodes_dic["12"].get(str(i)))
        return lis
    elif(code =="2-1"):
        lis=[]
        for i in range(s_year,c_year+1):
            lis.append(examcodes_dic["21"].get(str(i)))
        return lis
    elif(code =="2-2"):
        lis=[]
        for i in range(s_year,c_year+1):
            print(i)
            lis.append(examcodes_dic["22"].get(str(i)))
        return lis
    elif(code =="3-1"):
        lis=[]
        for i in range(s_year,c_year+1):
            lis.append(examcodes_dic["31"].get(str(i)))
        return lis
    elif(code =="3-2"):
        lis=[]
        for i in range(s_year,c_year+1):
            lis.append(examcodes_dic["32"].get(str(i)))
        return lis
    elif(code =="4-1"):
        lis=[]
        for i in range(s_year,c_year+1):
            lis.append(examcodes_dic["41"].get(str(i)))
        return lis
    elif(code =="4-2"):
        lis=[]
        for i in range(s_year,c_year+1):
            lis.append(examcodes_dic["42"].get(str(i)))
        return lis
